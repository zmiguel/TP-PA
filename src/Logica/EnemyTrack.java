 ...
 */
public class EnemyTrack implements Serializable {
    ...
    public boolean perdaJogoInsta(){
        return posBatteringRam == 0 && posLadder == 0 && posSiegeTower == 0;
    }

    public boolean perdaJogoFimTurno(){
        return posLadder == 0 && posBatteringRam == 0 || posLadder == 0 && posSiegeTower == 0 || posBatteringRam == 0 && posSiegeTower == 0;
    }

    @Override
    public String toString(){
        return ("\n\nENEMY TRACK\nPosition Ladders: " + posLadder + "\nPosition Battering Ram: " + posBatteringRam + "\nPosition Siege Tower: " + posSiegeTower + "\nTreebuchet count: " + trebuchet + "\n");
    }
